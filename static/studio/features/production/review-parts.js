...
export function reviewProperties(ctx,s) {
  ...
  return propertyTabs(ctx,[{id:'references',label:'参考',html:refs||'<p>本段未使用独立参考素材。</p>'},{id:'runs',label:'运行',html:ctx.executionCard(s)},{id:'script',label:'正文',html:`<p class="helper">当前编排原文；实际提交正文请在运行文件中查看。</p><div class="creation-prose">${ctx.esc(s.prompt)}</div>`}]);
}
