...
- 本项目沿用 `h3-video-chain-ui` 的Git历史与MIT许可，原许可证保留在根目录 `LICENSE`。
- 官方H3工作流来源和快照校验值见 `h3ui/studio_sources/manifest.json`。跳舞、Impact与文戏来源文件是用户提供的工作流快照；其创作者说明保留在原JSON中，本轮未重新授予这些文件许可。
- H3模型和ComfyUI插件需独立安装，本仓库不分发模型权重。各模型、插件遵循其自身许可。
